...
const COLORS = ['#6c3ce0', '#06b6d4', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899'];
                ...
                <AreaChart data={areaData}>
                  <defs>
                    <linearGradient id="colorMaint" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#6c3ce0" stopOpacity={0.8}/>
                  ...
                  <Tooltip />
                  <Area type="monotone" dataKey="requests" stroke="#6c3ce0" fillOpacity={1} fill="url(#colorMaint)" name="Requests" />
                </AreaChart>
              </ResponsiveContainer>
            )}
          </div>
