...
const typeConfig = {
  ...
  Maintenance: { icon: '🔧', bg: '#fff7ed', label: 'Maintenance' },
...
export default function ApprovalRequests() {
  ...
  const approvalStats = [
    ...
    { label: 'Maintenance Requests', value: counts[3] ?? 0, icon: '🔧', color: '#fff7ed' },
  ...
  return (
    <>
      ...
      <Topbar title="Approval Requests" subtitle="Review and take action on pending requests from your department." searchPlaceholder="Search requests by employee, asset, or ID..." />
