...
export default function BookResource() {
  ...
  const getTypeIcon = (type) => {
    switch (type) {
      case 'Meeting Room':
        return <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#6c3ce0" strokeWidth="1.5"><rect x="2" y="3" width="20" height="14" rx="2" /><line x1="8" y1="21" x2="16" y2="21" /><line x1="12" y1="17" x2="12" y2="21" /></svg>;
      case 'Conference Hall':
        return <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#6c3ce0" strokeWidth="1.5"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 00-3-3.87" /><path d="M16 3.13a4 4 0 010 7.75" /></svg>;
      case 'Company Car':
        return <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#6c3ce0" strokeWidth="1.5"><path d="M7 17m-2 0a2 2 0 104 0 2 2 0 10-4 0" /><path d="M17 17m-2 0a2 2 0 104 0 2 2 0 10-4 0" /><path d="M5 17H3v-6l2-5h9l4 5h1a2 2 0 012 2v4h-2" /><line x1="9" y1="17" x2="15" y2="17" /></svg>;
      default:
        return <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#6c3ce0" strokeWidth="1.5"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z" /></svg>;
    }
  };
