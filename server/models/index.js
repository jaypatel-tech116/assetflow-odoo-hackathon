...
// AssetCategory <-> CustomField
AssetCategory.hasMany(CustomField, { foreignKey: 'category_id', as: 'custom_fields', onDelete: 'CASCADE' });
CustomField.belongsTo(AssetCategory, { foreignKey: 'category_id', as: 'category' });
